...
// pattern
import { Character, Icon, Label, Pattern01, Pattern02 } from './pattern';
...
function CareerHeroIllustration({ sx, ...other }: BoxProps) {
  ...
  return (
    ...
    >
      ...
      {/* Icon */}
      <Box
        sx={{ position: 'absolute', top: 16, transform: 'translateX(20px)' }}
      >
      ...
      {/* Icon */}
      <Box
        sx={{ position: 'absolute', bottom: 16, transform: 'translateX(40px)' }}
      >
