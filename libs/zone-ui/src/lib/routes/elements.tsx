...
// TRAVEL
export const TravelAboutPage = Loadable(
  lazy(() => import('../pages/travel/TravelAboutPage'))
);
export const TravelBlogPage = Loadable(
  lazy(() => import('../pages/travel/TravelBlogPage'))
);
export const TravelCheckoutPage = Loadable(
  lazy(() => import('../pages/travel/TravelCheckoutPage'))
);
export const TravelContactPage = Loadable(
  lazy(() => import('../pages/travel/TravelContactPage'))
);
export const TravelLandingPage = Loadable(
  lazy(() => import('../pages/travel/TravelLandingPage'))
);
export const TravelOrderCompletedPage = Loadable(
  lazy(() => import('../pages/travel/TravelOrderCompletedPage'))
);
export const TravelPostPage = Loadable(
  lazy(() => import('../pages/travel/TravelPostPage'))
);
export const TravelTourPage = Loadable(
  lazy(() => import('../pages/travel/TravelTourPage'))
);
export const TravelToursPage = Loadable(
  lazy(() => import('../pages/travel/TravelToursPage'))
);

// CAREER
export const CareerAboutPage = Loadable(
  lazy(() => import('../pages/career/CareerAboutPage'))
);
export const CareerBlogPage = Loadable(
  lazy(() => import('../pages/career/CareerBlogPage'))
);
export const CareerContactPage = Loadable(
  lazy(() => import('../pages/career/CareerContactPage'))
);
export const CareerJobPage = Loadable(
  lazy(() => import('../pages/career/CareerJobPage'))
);
export const CareerJobsPage = Loadable(
  lazy(() => import('../pages/career/CareerJobsPage'))
);
export const CareerLandingPage = Loadable(
  lazy(() => import('../pages/career/CareerLandingPage'))
);
export const CareerPostPage = Loadable(
  lazy(() => import('../pages/career/CareerPostPage'))
);
...
// COMPONENTS
export const ComponentsPage = Loadable(
  lazy(() => import('../pages/components/ComponentsPage'))
);
export const DemoAnimatePage = Loadable(
  lazy(() => import('../pages/components/DemoAnimatePage'))
);
export const DemoCarouselsPage = Loadable(
  lazy(() => import('../pages/components/DemoCarouselsPage'))
);
export const DemoCountUpPage = Loadable(
  lazy(() => import('../pages/components/DemoCountUpPage'))
);
export const DemoFormValidationPage = Loadable(
  lazy(() => import('../pages/components/DemoFormValidationPage'))
);
export const DemoIconsPage = Loadable(
  lazy(() => import('../pages/components/DemoIconsPage'))
);
export const DemoImagePage = Loadable(
  lazy(() => import('../pages/components/DemoImagePage'))
);
export const DemoLabelPage = Loadable(
  lazy(() => import('../pages/components/DemoLabelPage'))
);
...
export const DemoPlayerPage = Loadable(
  lazy(() => import('../pages/components/DemoPlayerPage'))
);
