...
const CATEGORIES = [
  ...
  },
  {
    ...
    icon: '/assets/icons/e-commerce/ic_book.svg',
    path: '#',
  },
  {
    label: 'Home & Living',
    icon: '/assets/icons/e-commerce/ic_home_living.svg',
    path: '#',
  },
  {
    label: 'Health',
    icon: '/assets/icons/e-commerce/ic_health.svg',
    path: '#',
  },
  {
    label: 'Mobile',
  ...
  {
    label: 'Tablet',
    icon: '/assets/icons/e-commerce/ic_tablet.svg',
    path: '#',
  },
  {
    label: 'Headphones',
